...
bcell_df = pd.read_csv('Z:/0-Projects and Experiments/RS - lymphocyte activation/data/B-cells (Donors 1-3)/Bcell_cyto_2group.csv')
bcell_df.drop(['NADH', 'Group', 'Experiment_Date'], axis=1, inplace=True)
...
#B-cell UMAP - by CD69+ activation status
...
hv.save(overlay, 'bcell_hv_umap.html')

#%%  Section 6

#B-cell UMAP - By donor
...
hv.save(overlay, 'bcell_hv_d_umap.html')


#%%  Section 7

#B-cell UMAP - by donor and activation 
...
hv.save(overlay, 'bcell_hv_da_umap.html')


#%%  Section 8

#B-cell data UMAP with all groups (Activated + Quiescent, CD69+ and CD69-)
...
hv.save(overlay, 'bcell_group_umap.html')